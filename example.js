//1. create a function that calls itself that returns a function that takes a word
//from an array at random.
//2. Display the spaces in spans of the word in the html and in the guesses.
//3. when game is won display winning message or losing message
//4. Two final problems are to ignore letters that have already been guessed and not count
//an already correct letter in the this.correct count. 
//5.Problem with popular is it contains multiple instances of the same letter.
